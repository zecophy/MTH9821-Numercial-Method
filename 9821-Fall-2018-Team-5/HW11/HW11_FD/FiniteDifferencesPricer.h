 ...
 * 
 * IMPORTANT: This pricer is only for PUT options. If you want to
 * 			  price call option, you should modify all Boundary
 *            functions and domin computing functions in private
 *            section. You should also modify some measurements.
 *
 * Supported methods: 1.Forward 2.Backward 3.Crank-Nicolson 4.SOR for CN
 *
 * Supported options: 1.European 2.American 3.
 *
 ...
 * 
 * 1.1 Update log: add down-and-out call
 */
